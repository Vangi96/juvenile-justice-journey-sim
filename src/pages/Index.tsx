  ...
  const steps = [
    {
      ...
      content: (
        <div style={{ display: 'flex', alignItems: 'center', gap: '25px', marginBottom: '20px' }}>
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: '1.1em', lineHeight: 1.7 }}>You are a 16-year-old boy who fell in love with 16-year-old Ankita during computer class. Your relationship blossomed over shared dreams and late-night conversations about your future together.</p>
            <p style={{ marginTop: '15px', fontSize: '1.1em', lineHeight: 1.7 }}>However, you both came from different castes, and you knew your families would never accept this relationship. For an entire year, you kept your love secret, meeting only at school and communicating through hidden messages.</p>
          </div>
          <div style={{ flex: '0 0 200px' }}>
            <div style={{ background: 'linear-gradient(135deg, #ff9a9e, #fecfef)', borderRadius: '15px', padding: '30px', textAlign: 'center', boxShadow: '0 10px 25px rgba(255,154,158,0.3)' }}>
    ...
    },
    {
      ...
      content: (
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '25px', marginBottom: '20px' }}>
            <div style={{ flex: '0 0 200px' }}>
              <div style={{ background: 'linear-gradient(135deg, #ff6b6b, #ee5a52)', borderRadius: '15px', padding: '30px', textAlign: 'center', boxShadow: '0 10px 25px rgba(255,107,107,0.3)' }}>
                <div style={{ fontSize: '4em', marginBottom: '10px' }}>⛔</div>
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontSize: '1.1em', lineHeight: 1.7 }}>After a year, Ankita's family discovered your relationship. They were furious about the inter-caste nature of your love and immediately restricted Ankita's movements, taking away her phone and forbidding her from attending school.</p>
              <p style={{ marginTop: '15px', fontSize: '1.1em', lineHeight: 1.7, color: '#e74c3c', fontWeight: 500 }}>They threatened to arrange her marriage with someone from their own caste within days. You both realized this was your last chance to be together.</p>
            </div>
          </div>
          <div style={{ background: '#fff3cd', border: '2px solid #ffeaa7', borderRadius: '10px', padding: '20px', marginTop: '20px' }}>
